    ...
    return (
        <div className="h-screen">
            ...
            <div className="flex h-full overflow-hidden">
                {/* Sidebar */}
                <div className=" w-72 h-full bg-primary1 pt-14 flex justify-between flex-col">
                    <div className="menu">
                        <ul className="space-y-4">
                            <li className="">
                                <NavLink  to = "/" className = "">
                                    <div className="border-l-2 border-white text-white  flex px-9 space-x-4 h-12  items-center font-medium">
                            ...
                            <li className="">
                                <NavLink to = "/">
                                    <div className=" flex px-9 space-x-4 h-12 text-center text-gray-200 items-center font-medium">
