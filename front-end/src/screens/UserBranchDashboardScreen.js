...
const UserBranchDashboardScreen = () => {
    return (
        <SidebarWrapper>
                ...
                <div className=" flex-grow p-8 ">
                    ...
                    <div className="w-full bg-white mt-6 p-5 shadow-lg rounded-2xl">
                        <h2 className=" text-gray-800 text-4xl" >
                            ...
                            <span className="">#0001</span>
                        </h2>
                        <p className=" text-gray-400">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic error totam nisi quam laboriosam quibusdam in suscipit, placeat quis sequi blanditiis rem eos? Ut neque aspernatur dicta dolorem rem porro.
                        </p>
                            ...
                            <div className="">
                                <div className=" flex items-center space-x-2" >
                                    ...
                                    <div className=" flex space-x-2">
                                        ...
                                        <p className="text-gray-400">3026</p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-5 flex items-center space-x-2" >
                                    ...
                                    <div className="flex space-x-2">
                                        ...
                                        <p className="  text-gray-400"> 15000</p>
                                    </div>
                                </div>
                            ...
                            <div className="">
                                <div className=" flex items-center space-x-2" >
                                    ...
                                    <div className=" flex space-x-2">
                                        ...
                                        <p className=" text-gray-400">aybamz181@gmail.com</p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-5 flex items-center space-x-2" >
                                    ...
                                    <div className="flex space-x-2">
                                        ...
                                        <p className=" text-gray-400">07053332295</p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-5 flex items-center space-x-2" >
                                    ...
                                    <div className="flex space-x-2">
                                        ...
                                        <p className=" text-gray-400">No 1 Iyaloja St. Agege, Lagos</p>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div className="text-right text-primary1 mt-4">
                            Go To
                        </div>
                    </div>
                </div>
...
export default UserBranchDashboardScreen
