            ...
            <div className=" flex-grow p-8 ">
                ...
                <div className="w-full bg-white mt-6 p-5 shadow-lg rounded-2xl">
                    <div className="rounded-2xl h-16 p-2 grid grid-cols-3 bg-slate-50">
                        <div className=" flex justify-center items-center text-gray-400 text-lg font-semibold rounded-2xl cursor-pointer">Transactions</div>
                        <div className=" flex justify-center items-center text-gray-800 text-lg font-semibold rounded-2xl bg-white shadow-md">Branches</div>
...
export default UserSingleBranchScreen
